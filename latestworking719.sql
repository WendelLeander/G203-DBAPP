...
-- Table `mydb`.`athletes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`athletes` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`teams` (
  ...
  `gamesWon` INT(10) UNSIGNED ZEROFILL NOT NULL,
  `gamesLost` INT(10) UNSIGNED ZEROFILL NOT NULL,
  PRIMARY KEY (`teamID`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`athlete-team` (
  ...
  CONSTRAINT `FK1`
    ...
    REFERENCES `mydb`.`athletes` (`athleteID`),
  CONSTRAINT `FK4`
    FOREIGN KEY (`teamID`)
...
-- -----------------------------------------------------
-- Table `mydb`.`coach_exercises`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`coach_exercises` ;

CREATE TABLE IF NOT EXISTS `mydb`.`coach_exercises` (
  `exerciseID` VARCHAR(45) NOT NULL,
  `coachID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`exercise_record`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`exercise_record` ;

CREATE TABLE IF NOT EXISTS `mydb`.`exercise_record` (
  `assignmentID` VARCHAR(45) NOT NULL,
  `athleteID` VARCHAR(45) NOT NULL,
  `exerciseID` VARCHAR(45) NOT NULL,
  `assignedDate` VARCHAR(45) NOT NULL,
  `scheduledDate` VARCHAR(45) NOT NULL,
  `completedDate` VARCHAR(45) NULL DEFAULT NULL,
  `sets_assigned` VARCHAR(45) NULL DEFAULT NULL,
  `reps_assigned` VARCHAR(45) NULL DEFAULT NULL,
  `weight_assigned` VARCHAR(45) NULL DEFAULT NULL,
  `notes` MEDIUMTEXT NULL DEFAULT NULL,
  `status` ENUM('ongoing', 'completed', 'cancelled') NOT NULL,
  PRIMARY KEY (`assignmentID`),
  INDEX `athleteID_idx` (`athleteID` ASC) VISIBLE,
  INDEX `exerciseID_idx` (`exerciseID` ASC) VISIBLE,
  CONSTRAINT `athleteID`
    FOREIGN KEY (`athleteID`)
    REFERENCES `mydb`.`athletes` (`athleteID`),
  CONSTRAINT `exerciseID`
    FOREIGN KEY (`exerciseID`)
    REFERENCES `mydb`.`coach_exercises` (`exerciseID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `mydb`.`match_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`match_history` ;

CREATE TABLE IF NOT EXISTS `mydb`.`match_history` (
  `matchId` VARCHAR(45) NOT NULL,
  `teamID1` VARCHAR(45) NOT NULL,
  `teamID2` VARCHAR(45) NOT NULL,
  `team1Score` INT(10) UNSIGNED ZEROFILL NOT NULL,
  `team2Score` INT(10) UNSIGNED ZEROFILL NOT NULL,
  PRIMARY KEY (`matchId`),
  UNIQUE INDEX `matchId_UNIQUE` (`matchId` ASC) VISIBLE,
  INDEX `FKt1_idx` (`teamID1` ASC) VISIBLE,
  INDEX `Fkt2_idx` (`teamID2` ASC) VISIBLE,
  CONSTRAINT `FKt1`
    FOREIGN KEY (`teamID1`)
    REFERENCES `mydb`.`teams` (`teamID`),
  CONSTRAINT `Fkt2`
...
CREATE TABLE IF NOT EXISTS `mydb`.`performance` (
  ...
  INDEX `FK_athleteID_idx` (`athleteID` ASC) VISIBLE,
  CONSTRAINT `FK_athleteID`
    FOREIGN KEY (`athleteID`)
    REFERENCES `mydb`.`athletes` (`athleteID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
TRIGGER `mydb`.`venuereservation_BEFORE_INSERT`
BEFORE INSERT ON `mydb`.`venuereservation`
FOR EACH ROW
BEGIN
